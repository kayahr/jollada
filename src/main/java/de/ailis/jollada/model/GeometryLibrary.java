...
public final class GeometryLibrary extends Element implements AssetElement,
        Identifiable
{
    /** Serial version UID. */
    ...
    private final Geometries geometries = new Geometries(this);
     ...
     *
     * @return The list of geometries. Never null. May be empty.
     */
